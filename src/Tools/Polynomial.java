...
public class Polynomial {
    ...
    public static Polynomial generateRandomPoly(int degree, int primeQ){
        int threshold = degree+1;
        Polynomial finalPoly = new Polynomial(0,0);
        for(int i=0; i<=degree; i++){
            finalPoly = finalPoly.plus(new Polynomial(ThreadLocalRandom.current().nextInt(1, primeQ), i));
        }
        return finalPoly;//new Polynomial(0,0);
    }

    // test client
    public static void main(String[] args) {
        System.out.println("generated polynomial =  " + generateRandomPoly(5, 41));
